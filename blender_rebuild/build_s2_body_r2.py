...
# Standard flat-body vertical control levels. At the tapered cab and rear end
# they are remapped proportionally between each section's z_low and z_top.
STANDARD_Z_LEVELS = (
    0.280,
    0.380,
    0.650,
...
# Side recesses are structural grey-model guides aligned with the existing
# S1C door/glass/hatch components. They create local support loops and a small
# inward step; they are not final production openings or seals.
OPENINGS = (
    # Cab doors and glass zones.
    ...
    # Living windows retained as body-side inset guides.
...
def grid_boundary_points(x, width, z_low, z_top):
    ...
    # Left side, roof to bottom, excluding both corners.
