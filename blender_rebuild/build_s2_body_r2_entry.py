...
# Recess displacement is removed: the body now has actual holes and the
# existing door/glass/hatch components occupy those holes.
...
def build_true_opening_cage(parent, material):
    ...
    # Keep source opening borders stable through subdivision.
