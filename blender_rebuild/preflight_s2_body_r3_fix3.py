"""Run the extended R3 preflight against the final cab-door fix."""
...
FIX_PATH = SCRIPT_DIR / "build_s2_body_r3_fix3.py"
FIX_SPEC = importlib.util.spec_from_file_location("nomadhub_s2_r3_fix3", FIX_PATH)
if FIX_SPEC is None or FIX_SPEC.loader is None:
    raise RuntimeError(f"unable to load final R3 fix: {FIX_PATH}")
